...
plot(plot_data$DateTime, plot_data$Voltage, type = "n", ylab = "Voltage", xlab = "datetime")
...
plot(plot_data$DateTime, plot_data$Global_reactive_power, type = "n", ylab = "Global_reactive_power", xlab = "datetime")
